...
if (($_SESSION['typ']>0)) {
    ...
    if (isset($_GET['request'])){
        ...
        if($_GET['request']>=0) {
            $id = $_GET['request'];
            $stmt = $connection->prepare("UPDATE userCategory SET name=? WHERE (ID=?)");
            $stmt->bind_param("ss", $name, $id);

        }
        else if( $_GET['request']==-1){
            $stmt = $connection->prepare("INSERT INTO userCategory (name) VALUES (?)");
    ...
    <head>
        ...
        <title>مدیریت دسته بندی کاربران</title>
        ...
        <div id="page-wrapper">
                ...
                while ($row=$result->fetch_assoc()) {
                    ...
                    ?>
                        <tr class="<?php echo $id;?>">
                            <form action="manageUsersCategory.php?request=<?php echo $id;?>" method="post"  class="form-row mt-5" id="<?php echo $id;?>">
                            <td  style="width: 40%;">
                                <div dir="rtl" >
                            ...
                            <td style="width: 5%;">
                                <a onclick="return confirming();" href="deleteblog.php?type=4&product=<?php echo $id?>">
                                    <span class="fa-stack">
            ...
            <div class="form-group col-md-10 row mt-4 ml-auto mr-auto">
                <div class="col-md-5 col-12 mt-2 ml-auto mr-auto">
                    <div class="btn btn-default col-md-12 col-12" onclick="myFunction2()">اضافه کردن</div>
                </div>
            </div>
