...
if (($_SESSION['typ']>0)) {
    ...
    if (isset($_GET['request'])){
        ...
        $writer->writeElement('description', 'درباره ما');
        $writer->writeElement('kewords', 'درباره ما');
        $writer->writeElement('seotitle','درباره ما');
        ...
        echo '<META HTTP-EQUIV="Refresh" Content="0; URL=/aboutUs.php">';
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <form action="aboutUsSetting.php?request=save" method="post"  class="form-row" onsubmit="return validateFormdata(1)">
                <div class="form-group col-md-10 m-auto text-right pt-5" >
                    <label for="editor1" class="dark_text"><b>متن در باره ما</b></label>
                    <div id="editor">
                ...
                <div class="form-group col-md-10 m-auto text-right pt-5" >
                    <label for="editor1" class="dark_text"><b>متن چشم انداز</b></label>
                    <div id="editor2">
                        <div id='edit2' style="margin-top: 30px;"><?php echo $datashould2; ?></div>
                    </div>
                    <input name="editor2" id="editor123" class="form-control input-lg ckeditor d-none"
                           type="text"/>
                </div>
