...
if (($_SESSION['typ']>0)) {
    ...
    <head>
        ...
        <title>مدیریت دسته بندی مقالات</title>
        ...
        <div id="page-wrapper">
            ...
            <table class="table user-list " id="menuTable">
                ...
                while ($row=$result->fetch_assoc()) {
                    ...
                    <tr class="<?php echo $id;?>">
                        <form action="managePapersCategory.php?request=<?php echo $id;?>" method="post"  class="form-row mt-5" id="<?php echo $id;?>">
                            <td  style="width: 40%;">
                                <div dir="rtl" >
            ...
            <div class="form-group col-md-10 row mt-4 ml-auto mr-auto">
                <div class="col-md-5 col-12 mt-2 ml-auto mr-auto">
                    <div class="btn btn-default col-md-12 col-12" onclick="myFunction3()">اضافه کردن</div>
                </div>
            </div>
