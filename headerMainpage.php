    ...
    <div class="fixed fix fixed1 headerall">
        <div class="row">
            ...
            <div class="col-md-2 log_reg_block row">
                <div class="m-auto"><a class="dark_text" href="/login.php">ورود</a></div>
                <div class="m-auto"><a class="dark_text" href="/register.php">عضویت<a/></div>
            </div>
        </div>
...
<div class="header col-lg-12 col-md-12 headerfix hidden-md hidden-lg hiddenthisoverxs">
    ...
    <div class="col-12 navbar-text cover_menu" >
        <div class="row log_reg_block_mob">
            ...
            <div class="d-block offset-1"><a class="dark_text" href="/login.php">ورود</a></div>
            <div class="d-block offset-1"><a class="dark_text" href="/register.php">عضویت<a/></div>
        </div>
